...
class PageTwo(Frame):
    def __init__(self, master):
        ...
        self.order_variable_display.grid(row = 1, column = 2, sticky = 'w')
        ...
        style_pull1.config(width = 20, height = 1, font=('Helvetica', 12))
        ...
        style_pull2.config(width = 20, height = 1, font=('Helvetica', 12))
        ...
        style_pull3.config(width = 20, height = 1, font=('Helvetica', 12))
        ...
        style_pull4.config(width = 20, height = 1, font=('Helvetica', 12))
        ...
        style_pull5.config(width = 20, height = 1, font=('Helvetica', 12))
